...
public class ExceptionDialog extends JDialog {
	...
	private JButton viewButton = new JButton("Detalhes >>");
	...
	public ExceptionDialog(String errorLabelText, String errorDescription,
		...
		errorLabel.setText("<html><b>"+errorLabelText+"<b><html>");
	...
	public void setupUI() {
		...
		exceptionTextArea.setPreferredSize(new Dimension(100, 300));
		...
		viewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (open) {
					...
					ExceptionDialog.this.setSize(dialogWidth, dialogHeight + 320);
					topPanel.revalidate();
					open = true;
				}
			}
